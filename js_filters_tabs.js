...
function renderVulnerables() {
  ...
  grupos.forEach(function(g, i) {
    ...
    if (hasDatos) html += '<div style="display:inline-flex;align-items:center;gap:5px;background:'+cc+'18;border:1px solid '+cc+'44;border-radius:8px;padding:3px 9px;margin-bottom:6px"><span style="font-family:DM Mono,monospace;font-size:15px;font-weight:400;color:'+cc+'">'+cobNum.toFixed(1)+'%</span><span style="font-size:11px;color:'+cc+';opacity:.7">cobertura</span></div>';
    ...
    html += '<span style="font-size:14px;color:#cdd9e5;font-weight:400">'+pobRel+'%</span></div>';
    ...
    if (hasDatos) {
      ...
      if (diff25 !== null) html += '<span style="font-size:14px;font-weight:400;color:'+dCol25+';background:'+dCol25+'18;padding:1px 7px;border-radius:4px">'+(isUp25?'▲':'▼')+' '+Math.abs(diffPct25).toFixed(1)+'%</span>';
      html += '</div>';
  ...
  html += '<div style="font-size:31px;font-weight:500;color:'+cobColor2+';font-family:DM Mono,monospace;line-height:1">'+cobGeneral.toFixed(1)+'<span style="font-size:17px">%</span></div>';
  ...
  html += '<span style="font-size:13px;font-weight:400;color:'+colG+';background:'+colG+'18;padding:2px 8px;border-radius:5px">'+signG+' '+Math.abs(diffPctG).toFixed(1)+'%</span></div>';
  html += '<div style="display:flex;flex-direction:column;gap:6px">';
  html += '<div style="display:flex;align-items:center;gap:8px">';
  html += '<span style="font-size:12px;font-weight:400;color:'+colG+';min-width:28px">2026</span>';
  ...
  window.gvSelectCard = function(i) {
    ...
    ph += '<div style="font-size:20px;font-weight:400;color:'+cc2+';font-family:DM Mono,monospace;line-height:1">'+cobNum2.toFixed(1)+'%</div>';
    ...
    ph += '<div style="font-size:16px;font-weight:400">'+diffStr2+' <span style="color:'+dirColor2+'">'+dirLabel2+'</span></div></div>';
    ...
    ph += '<div style="background:#161b22;border-radius:8px;padding:9px 11px"><div style="color:#484f58;font-size:12px;text-transform:uppercase;letter-spacing:.08em;margin-bottom:3px">Atendidos</div><div style="color:#ffa657;font-weight:400;font-family:DM Mono,monospace;font-size:16px">'+fmt(g.atendidos)+'</div></div>';
    ph += '<div style="background:#161b22;border-radius:8px;padding:9px 11px"><div style="color:#484f58;font-size:12px;text-transform:uppercase;letter-spacing:.08em;margin-bottom:3px">Sin atender</div><div style="color:#f85149;font-weight:400;font-family:DM Mono,monospace;font-size:16px">'+fmt(noAtend)+'</div></div>';
    ph += '<div style="background:#161b22;border-radius:8px;padding:9px 11px"><div style="color:#484f58;font-size:12px;text-transform:uppercase;letter-spacing:.08em;margin-bottom:3px">Pob. vulnerable</div><div style="color:#8b949e;font-weight:400;font-family:DM Mono,monospace;font-size:16px">'+fmt(g.pob_vulnerable)+'</div></div>';
    ph += '<div style="background:#161b22;border-radius:8px;padding:9px 11px"><div style="color:#484f58;font-size:12px;text-transform:uppercase;letter-spacing:.08em;margin-bottom:3px">Cobertura</div><div style="color:'+cc2+';font-weight:400;font-family:DM Mono,monospace;font-size:16px">'+cobNum2.toFixed(1)+'%</div></div>';
    ph += '</div></div>';
    panel.innerHTML = ph;
  };
}
